...
'			Me.saSimpleActionInvoker.Execute += New DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler(Me.saSimpleActionInvoker_Execute);
			' 
...
'			Me.saSingleChoiceActionInvoker.Execute += New DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler(Me.saSingleChoiceActionInvoker_Execute);
			' 
...
'			Me.saPopupWindowShowActionInvoker.Execute += New DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler(Me.saPopupWindowShowActionInvoker_Execute);
			' 
...
'			Me.saParametrizedActionInvoker.Execute += New DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler(Me.saParametrizedActionInvoker_Execute);
			' 
